...
\NormalTok{st_atime = time(NULL);    }\CommentTok{// alle Zeiten auf den aktuellen Zeitstempel}
\NormalTok{st_mtime = time(NULL);    }\CommentTok{// "}
\NormalTok{st_ctime = time(NULL);    }\CommentTok{// "}
